...
def userinput():
    input_char = ''
    input_num = 0
    print "Please input the pcb manufacturer: C, E or P \n"
    while True:
        userInput = raw_input(':')
        if len(userInput) == 1:
    ...
    input_char = userInput
    print input_char
    print "Please input the board number \n"
    while True:
        userInput = raw_input(':')
...
def runPlotNoise(fname):
    ...
    run_dir = 'pcb_testing/'+ mydir + '_plots/'
